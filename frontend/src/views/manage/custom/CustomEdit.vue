<template>
  <a-modal v-model="show" title="修改定制药品" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='定制药品标题' v-bind="formItemLayout">
            <a-input v-decorator="[
            'title',
        ...
        <a-col :span="12">
          <a-form-item label='定制药品状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入定制药品状态!' }] }
              ]">
        ...
        <a-col :span="24">
          <a-form-item label='定制药品内容' v-bind="formItemLayout">
