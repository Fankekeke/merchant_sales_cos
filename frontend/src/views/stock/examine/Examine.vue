<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      <div class="operator">
        <a-button type="primary" ghost @click="add">问题检查</a-button>
...
import purchaseAdd from './ExamineAdd.vue'
import purchaseView from './ExamineView.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/examine-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/examine-info/page', {
        ...params
      }).then((r) => {
