...
//        return R.ok(pharmacyInventoryService.batchPutInventory(pharmacyId, pharmacyInventoryList));
     ...
     * @return 结果
     */
    @GetMapping("/queryDrugByPurchaseCode")
    public R queryDrugByPurchaseCode(@RequestParam("purchaseCode") String purchaseCode) {
        return R.ok(pharmacyInventoryService.queryDrugByPurchaseCode(purchaseCode));
    }
